            ...
            <div class="d-flex align-items-center me-3">
                <a href="#" class="d-flex align-items-center text-decoration-none">
                    ...
                    <div class="d-flex flex-column d-none d-lg-flex" style="line-height: 1.2;">
                        <a href="{{ route('login')}}" class="text-decoration-none"><span class=" fw-semibold text-white p-lg-1 ">¡Hola! Inicia Sesión</span></a>
                        <a href="{{ route('signup')}}" class="text-decoration-none"><small class="text-secondary text-center">¿Eres Nuevo? Regístrate</small></a>
                    </div>
                </a>
            </div>
