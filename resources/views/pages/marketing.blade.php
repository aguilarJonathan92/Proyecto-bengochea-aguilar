    ...
    <div class="container p-2 p-md-4 px-lg-5">
        <div class="terms-decoration text-light my-4 px-3 px-md-5 pb-4">
            ...
            <p class="pb-2">En Soundwave Store desarrollamos un modelo de comercialización integral orientado a
                ...
                hasta la entrega final al cliente.</p>
            <h3>Estrategia de abastecimiento</h3>
            <p class="pb-2">Trabajamos con proveedores nacionales e internacionales cuidadosamente seleccionados,
                priorizando la calidad, la trazabilidad y la continuidad en el suministro. Mantenemos acuerdos
                comerciales que aseguran disponibilidad constante de productos y condiciones competitivas en el mercado
                argentino.</p>
            ...
            <p class="pb-2">mplementamos una política de precios transparente y competitiva, acompañada de opciones de
                financiación flexibles. Esto nos permite atender tanto a clientes individuales como a instituciones
                educativas y culturales que requieren soluciones adaptadas a sus presupuestos.</p>

            <h3>Logística y distribución</h3>
            <p class="pb-2">Contamos con alianzas estratégicas con operadores logísticos locales y nacionales, lo que
                nos permite garantizar entregas seguras y en plazos confiables. Cada envío es gestionado bajo protocolos
                de embalaje que aseguran la integridad del instrumento.</p>
