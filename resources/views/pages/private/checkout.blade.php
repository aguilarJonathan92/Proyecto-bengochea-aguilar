        ...
        <div class="row g-4">
            <div class="col-md-7 col-lg-8 order-2 order-md-1">
                <div class="checkout-section-card shadow-sm p-4">
                    ...
                    <form action="{{ route('checkout.store') }}" method="POST" id="form-checkout" class="needs-validation" novalidate>
                        @csrf
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <select name="user_address_id" id="select-direccion-checkout" class="form-select checkout-input" onchange="evaluarDireccionNueva(this)" required>
                                    ...
                                    @endforeach
                                    <option value="nueva_direccion" {{ old('user_address_id', $direcciones->isEmpty() ? 'nueva_direccion' : '') == 'nueva_direccion' ? 'selected' : '' }}>
                            ...
                            <div id="bloque-nueva-direccion" class="{{ $direcciones->isNotEmpty() && old('user_address_id', 'guardada') !== 'nueva_direccion' ? 'd-none' : '' }} mt-3">
                                <div class="p-3 bg-superficie-adaptativa rounded border border-ui-adaptativa row g-3">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <select id="select-provincia-checkout" 
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="hidden" name="delivery_city_id" id="hidden-city-id" value="{{ old('delivery_city_id') }}">
                        ...
                        <div class="payment-options d-flex flex-column gap-2">
                            <div class="form-check checkout-payment-option p-3 rounded border">
                                <input id="credit" name="paymentMethod" type="radio"
                                    class="form-check-input ms-0 me-2" value="credit" 
                                    {{ old('paymentMethod') == 'credit' ? 'checked' : '' }} required>
                                <label class="form-check-label color-adaptativo fw-bold" for="credit">
                                    Tarjeta de Crédito / Débito
                                </label>
                            </div>
                            <div class="form-check checkout-payment-option p-3 rounded border">
                                <input id="transfer_bank" name="paymentMethod" type="radio"
                                    class="form-check-input ms-0 me-2" value="transfer_bank" 
                                    {{ old('paymentMethod') == 'transfer_bank' ? 'checked' : '' }} required>
                                <label class="form-check-label color-adaptativo fw-bold" for="transfer">
                                    Transferencia Bancaria
                                </label>
                            </div>
                            <div class="form-check checkout-payment-option p-3 rounded border">
                                <input id="transfer_mp" name="paymentMethod" type="radio"
                                    class="form-check-input ms-0 me-2" value="transfer_mp" 
                        ...
                        <div id="payment-error" class="text-danger small mt-2 d-none" style="font-size: 0.85rem;">
                            <i class="bi bi-exclamation-circle-fill me-1"></i> Seleccioná un método de pago para continuar.
                        </div>
